...
option(ENABLE_COMPILE_WARNINGS_AS_ERRORS "Treat compiler warnings as errors." OFF)

if(ENABLE_COMPILE_WARNINGS_AS_ERRORS)

    set(ENABLE_WARNINGS_AS_ERRORS_MSVC_FLAG /WX)
    set(ENABLE_WARNINGS_AS_ERRORS_CLANG_FLAG -Werror)

endif()

#
# Add supported compiler warnings to ${target_interface}.
#

function(add_compile_warnings target_interface)

    if(MSVC)

        add_msvc_warnings(${target_interface})

    elseif(CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")

        add_clang_warnings(${target_interface})

    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")

        add_gcc_warnings(${target_interface})
...
#
# Add MSVC warnings to ${target_interface}.
#

function(add_msvc_warnings target_interface)

    target_compile_options(${target_interface}
                           INTERFACE
                               ${ENABLE_WARNINGS_AS_ERRORS_MSVC_FLAG}
...
#
# Add Clang warnings to ${target_interface}.
#

function(add_clang_warnings target_interface)

    target_compile_options(${target_interface}
                           INTERFACE
                               ${ENABLE_WARNINGS_AS_ERRORS_CLANG_FLAG}
                               -Wall
...
#
# Add GCC warnings to ${target_interface}.
#

function(add_gcc_warnings target_interface)

    # Add gcc common warnings with clang.
    add_clang_warnings(${target_interface})

    # Add gcc specifics warnings.
    target_compile_options(${target_interface}
                           INTERFACE
